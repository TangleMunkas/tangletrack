...
public class VehicleController : MonoBehaviour
{
    ...
    public void OnTouchEnded()
    {
        ...
        indicateAlign.DestroyIndicateAligns();
        AlignToGrid();
        ...
        // Frissítjük az előző pozíciót
        lastPosition = CalculateAlign(vehicleInfo.vehicleLength, vehicleInfo.isHorizontal, transform.position);
        beforePosition = CalculateAlign(vehicleInfo.vehicleLength, vehicleInfo.isHorizontal, transform.position);
    }
